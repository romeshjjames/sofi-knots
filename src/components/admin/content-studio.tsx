...
const pageStarters = [
  {
    ...
    body: [
      ...
      { type: "paragraph", content: "Fast, reliable delivery for thoughtfully crafted pieces.", sectionId: "home-intro", sectionLabel: "Welcome intro", sectionTheme: "paper", sectionLayout: "stacked", sectionSpacing: "compact" },
      ...
      { type: "paragraph", content: "Handmade quality shaped with patience, care, and premium finishing.", sectionId: "home-intro", sectionLabel: "Welcome intro", sectionTheme: "paper", sectionLayout: "stacked", sectionSpacing: "compact" },
      { type: "heading", content: "Organic Materials", level: "h3", sectionId: "home-intro", sectionLabel: "Welcome intro", sectionTheme: "paper", sectionLayout: "stacked", sectionSpacing: "compact" },
      { type: "paragraph", content: "Soft fibers and natural textures selected for beauty and longevity.", sectionId: "home-intro", sectionLabel: "Welcome intro", sectionTheme: "paper", sectionLayout: "stacked", sectionSpacing: "compact" },
      { type: "heading", content: "4.9 Customer Rating", level: "h3", sectionId: "home-intro", sectionLabel: "Welcome intro", sectionTheme: "paper", sectionLayout: "stacked", sectionSpacing: "compact" },
      { type: "paragraph", content: "A trusted favorite for gifting, styling, and meaningful keepsakes.", sectionId: "home-intro", sectionLabel: "Welcome intro", sectionTheme: "paper", sectionLayout: "stacked", sectionSpacing: "compact" },
      ...
      { type: "paragraph", content: "Curated edits of woven bags, statement wall hangings, jewelry, and finishing accents designed to bring warmth, texture, and handmade character into everyday living.", sectionId: "home-collections", sectionLabel: "Collections", sectionTheme: "paper", sectionLayout: "stacked", sectionSpacing: "airy" },
      ...
      { type: "paragraph", content: "Showcase the pieces customers come back to most, from signature bags to soft home accents and handcrafted details.", sectionId: "home-featured", sectionLabel: "Featured products", sectionTheme: "paper", sectionLayout: "stacked", sectionSpacing: "airy" },
      ...
      { type: "paragraph", content: "Every Sofi Knots piece begins with a single strand of organic cotton and hours of meditative knotting. Use this section for the craft story split block.", sectionId: "home-values", sectionLabel: "Why Sofi Knots", sectionTheme: "paper", sectionLayout: "split", sectionSpacing: "airy" },
      ...
      { type: "paragraph", content: "Be the first to know about new collections, artisan stories, and exclusive offers.", sectionId: "home-newsletter", sectionLabel: "Newsletter", sectionTheme: "paper", sectionLayout: "stacked", sectionSpacing: "airy" },
